...
<body>
    <div id="app">
        ...
        {{-- Header --}}
        <header class="navbar-dark d-flex sticky-top my-bg-primary flex-md-nowrap align-items-center px-3 shadow admin-header">
                    ...
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                           <li class="nav-item rounded {{ Route::currentRouteName() == 'admin.dashboard' ? 'my-selected' : '' }}">
                            ...
                            <li class="nav-item rounded {{ Route::currentRouteName() == 'admin.plates.index' ? 'my-selected' : '' }}">
